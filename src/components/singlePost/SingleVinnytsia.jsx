...
import blogImg from "../../images/vinnitsia.jpg"
import ReactPlayer from 'react-player/youtube'
export default function SingleVinnytsia() {
    return (
        <div className="singlePost">
            <div className="singlePostWrapper">
                ...
                />
                <h1 className="singlePostTitle">Vinnytsia</h1>
                ...
                <div className="video">
                    <ReactPlayer url="https://youtu.be/B32FUMx9Jlk" />
                </div>
            </div>
        </div>
    );
